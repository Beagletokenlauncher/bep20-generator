        ...
        <b-row>
            <b-col>
                <b-card bg-variant="light" class="mb-4">
                    <h3 class="font-weight-light">Beagle Token Launcher</h3>
                    ...
                    <div class="accordion mb-3" role="tablist">
                        ...
                        <b-card no-body
                            ...
                            <b-collapse id="what-is-token-recover" class="p-4" accordion="features-accordion">
                                ...
                                <b-link href="https://beagletokenlauncher.github.io/eth-token-recover/"
                                        class="card-link" target="_blank">
        ...
        <b-row>
            <b-col>
                <b-alert show variant="warning" class="mt-4">
                    ...
                    <p>
                        Beagle Token Launcher and its author are free of any liability regarding Tokens built using
                        this App, and the use that is made of them. Tokens built on Beagle Token Launcher, their
                        projects, their teams, their use of Token (as well as anything related to Token) are in no way
                        connected to Beagle Token Launcher or its author.
                    </p>
                    <hr>
                    <small>
                        Beagle Token Launcher's code is provided under MIT License. Anyone can use it as per their
